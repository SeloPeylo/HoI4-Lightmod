...
NDiplomacy = {
	...
	BASE_GENERATE_WARGOAL_DAILY_PP = 0.25,	-- Daily pp cost for generation of wargoals
	WARGOAL_VERSUS_MAJOR_AT_WAR_REDUCTION = -0.75, 	-- reduction of pp cost for wargoal vs major at war.
	WARGOAL_WORLD_TENSION_REDUCTION = -0.75,			-- Reduction of pp cost for wargoal at 100% world tension, scales linearly
	...
	IC_TO_EQUIPMENT_COUP_RATIO = 0.5,				-- Ratio for calculating cost of staging coup #0.1
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.2,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	...
	BASE_CONDITIONAL_PEACE_MONTHS = 3,				-- War length must be before a surrender i possible.
	...
	MAX_REMEMBERED_LEASED_IC = 2000,				-- Maximum of leased equipment value that is remembered for opinion bonus
	MAX_OPINION_FOR_LEASED_IC = 50,					-- Positive opinion when remembering the MAX_REMEMBERED_LEASED_IC equipment
	MONTHLY_LEASED_IC_DECAY = 100,					-- How much of leased equipment is being "forgot" each month
	OPINION_PER_VOLUNTEER = 5,						-- Opinion bonus per one sent volunteer division
	MAX_OPINION_FROM_VOLUNTEERS = 25,				-- Opinion bonus per one sent volunteer division
...
NCountry = {
	...
	LOCAL_MANPOWER_ACCESSIBLE_FACTOR = 0.75,         -- accessible recruitable factor base
	...
	DEFAULT_NATIONAL_UNITY = 0.5,					-- Default national unity if not scripted otherwise.
	MAX_NATIONAL_UNITY = 0.99,
	...
	MIN_MANPOWER_RATIO = 0.05,						-- Min manpower ratio to show manpower alert
...
NProduction = {
	...
	MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 1.0,	-- Ratio which % of army in field can be trained
},
...
NTechnology = {
	...
	BASE_YEAR_AHEAD_PENALTY_FACTOR = 1.75,		-- Base year ahead penalty
...
NMilitary = {
	...
	CORPS_COMMANDER_CAP = 20,			-- how many a corps commander is limited to. 0 = inf
	FIELD_MARSHALL_CAP = 100,			-- how many a marshall is limited to. 0 = inf
